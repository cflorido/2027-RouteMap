  ...
  const [quests, setQuests] = useState([
    {
      ...
      completed: false,
      description: "Un año trabajando en una startup tecnologia",
      illustration: "☕",
      notes: ""
    },
    {
      ...
      completed: false,
      description: "Trabajar en Sezzle por 6 meses",
      illustration: "⚡",
      notes: ""
    },
    {
      id: 3,
      title: "Completar dos carreras lol - Promedio 4.8",
      iconName: "Star",
      progress: 0,
      maxProgress: 4.8,
      unit: "GPA",
      ...
      completed: false,
      description: "Ing sistemas, Ing industrial",
      illustration: "⭐",
      notes: ""
    },
    {
      ...
      completed: false,
      description: "Santiago, Valerie, Juan Fernando, (del trabajo pedirle a Carlos)",
      illustration: "📚",
      notes: ""
    },
    {
      id: 5,
      title: "Hacer el paper",
      iconName: "Award",
      progress: 0,
      maxProgress: 1,
      unit: "paper",
      ...
      completed: false,
      description: "Paper publicado en Privacidad Diferencial",
      illustration: "🔬",
      notes: ""
    },
    {
      ...
      completed: false,
      description: "Certificado lol",
      illustration: "☁️",
      notes: ""
    },
    {
      id: 7,
      title: "A ver si hacemos algo con CodeLab",
      iconName: "Sparkles",
      progress: 0,
      maxProgress: 3,
      unit: "proyectos",
      ...
      completed: false,
      description: "Intentar sacar proyectos buenos",
      illustration: "💻",
      notes: ""
    },
    {
        ...
        <div className="bg-white rounded-3xl p-6 mb-8 shadow-lg border-4 border-purple-200">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-700">¿Cuanto me falta?</span>
            </div>
